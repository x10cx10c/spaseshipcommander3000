...
int main(void)
{
    ...
    // shader = LoadShader(0, TextFormat("resources/shader.fs", GLSL_VERSION)); //actualy wont work
    ...
    // printf("1.0.1\n");
    music = LoadMusicStream("resources/ES_Lost_in_the_Clouds_Aerian.mp3");
    // printf("1.0.2\n");
...
static void UpdateDrawFrame(void)
{
    ...
    BeginDrawing();
        ...
        // Color col = CLITERAL(Color){ 0, 0, 0, 0 } ;
